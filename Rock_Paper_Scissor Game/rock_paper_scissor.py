...
# main window
root = Tk()
root.title("Rock Scissor Paper")  # Corrected the typo
...
rock_img_comp = ImageTk.PhotoImage(Image.open("rock-pc.png"))
paper_img_comp = ImageTk.PhotoImage(Image.open("paper.png"))
scissor_img_comp = ImageTk.PhotoImage(Image.open("scissor-pc.png"))

#insert picture
user_label = Label(root,image=scissor_img,bg="pink",)
comp_label = Label(root,image=scissor_img_comp,bg="pink")
